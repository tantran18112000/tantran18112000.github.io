<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DHSPKT.aspx.cs" Inherits="DHSPKT" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <div>
          ...
          <%-- <div style="background-color:antiquewhite;height:180px">
               <div style="margin-right:100px">
                    <a class="logo float-right" href="index.html">
                        <h3>GVHD : TS. Nguyễn Văn Thái</h3>
               ...
               <div class="d-flex flex-column min-vh-100 justify-content-center" style="height:200px;margin-left:100px">
                    <h4>HỌ & TÊN  :ĐỖ MINH HIỂN</h4>
                    <h4> MSSV     :18151173</h4>
                    <h4> LỚP      :SCADA_THỨ 3_TIẾT 13-15</h4>
               </div>
        ...
        <div style="background-color:antiquewhite;padding-bottom: 33px;">
             <section>
                <div class="container" style="background:center;background-color:aliceblue">
                 <a class="logo float-left" href="index.html">
                      <img src="assets/images/_smarty/spkt.jpg" style="height:400px;width:550px" alt="" />
                <%-- </a>
                <a class="logo float-right" href="index.html">--%>
                    <img src="assets/images/_smarty/spkt2.jpeg" style="height:400px;width:550px"  alt="" />
                </a>
                
                <p>Trường ĐH Sư Phạm Kĩ Thuật TP Hồ Chí Minh (tiếng Anh: Ho Chi Minh City University of Technology and Education) </p>
                <p> Địa chỉ: 01, Võ Văn Ngân, P.Linh Chiểu, Thành Phố Thủ Đức, Thành phố Hồ Chí Minh</p>
							...
							<address>
								<ul class="list-unstyled">
									...
									<li class="footer-sprite email">
										<a href="mailto:support@yourname.com">dominhhien16042000@gmail..com</a>
									</li>
                                    <li></li>
